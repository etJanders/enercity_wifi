...
import 'add_new_room_to_schedule_content.dart';
...
class AddRoomToHoldiaySchedulePage extends StatelessWidget {
  static const routName = "/add_room_to_holiday_schedule_page";
  const AddRoomToHoldiaySchedulePage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        body: AddRoomToHolidayScheduleContent(
          smPublicId: manager.entryPublicId,
        ),
      ),
    );
